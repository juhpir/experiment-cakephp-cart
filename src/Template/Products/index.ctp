    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('price_eur') ?></th>
                <th scope="col"><?= $this->Paginator->sort('weight_kg') ?></th>
                <th scope="col"><?= $this->Paginator->sort('length_cm') ?></th>
                <th scope="col"><?= $this->Paginator->sort('age_years') ?></th>
